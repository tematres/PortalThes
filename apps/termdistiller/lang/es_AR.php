...
define('TERMS_DISTILLER_title','Servicio de extracción de palabras clave');
define('TERMS_DISTILLER_help','Texto breve para analizar');
define('TERMS_DISTILLER_terms_tag','Elimine los términos que considera incorrectos. El máximo de términos a evaluar es %s');
define('TERMS_DISTILLER_description','Esta herramienta permite analizar un texto breve e identificar <strong>potenciales palabras clave</strong> utilizando el ');
